...
import Learning from '../../components/_learn/Learning';
import StartLearn from '../../components/_learn/StartLearn';
import EndLearn from '../../components/_learn/EndLearn';
						...
						<StartLearn
							...
							start={() => {
								if (
									...
									!props.lists
										.filter((list) => list.forLearn === true)
